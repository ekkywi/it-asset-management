    ...
    <form class="form-inline mr-auto">
        ...
        <div class="search-element">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="assets/img/products/product-3-50.png" width="30">
                        oPhone S9 Limited Edition
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="assets/img/products/product-2-50.png" width="30">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img alt="product" class="mr-3 rounded" src="assets/img/products/product-1-50.png" width="30">
                        Headphone Blitz
                    </a>
                </div>
                <div class="search-header">
        ...
        <li class="dropdown dropdown-list-toggle"><a class="nav-link nav-link-lg message-toggle beep" data-toggle="dropdown" href="#"><i class="far fa-envelope"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-message">
                    <a class="dropdown-item dropdown-item-unread" href="#">
                        <div class="dropdown-item-avatar">
                            <img alt="image" class="rounded-circle" src="assets/img/avatar/avatar-1.png">
                    ...
                    <a class="dropdown-item dropdown-item-unread" href="#">
                        <div class="dropdown-item-avatar">
                            <img alt="image" class="rounded-circle" src="assets/img/avatar/avatar-2.png">
                        </div>
                        <div class="dropdown-item-desc">
                            <b>Dedik Sugiharto</b>
                    ...
                    <a class="dropdown-item dropdown-item-unread" href="#">
                        <div class="dropdown-item-avatar">
                            <img alt="image" class="rounded-circle" src="assets/img/avatar/avatar-3.png">
                            <div class="is-online"></div>
                        </div>
                        <div class="dropdown-item-desc">
                    ...
                    <a class="dropdown-item" href="#">
                        <div class="dropdown-item-avatar">
                            <img alt="image" class="rounded-circle" src="assets/img/avatar/avatar-4.png">
                        </div>
                        <div class="dropdown-item-desc">
                    ...
                    <a class="dropdown-item" href="#">
                        <div class="dropdown-item-avatar">
                            <img alt="image" class="rounded-circle" src="assets/img/avatar/avatar-5.png">
                        </div>
                        <div class="dropdown-item-desc">
                            <b>Alfa Zulkarnain</b>
